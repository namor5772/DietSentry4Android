// DietSentry for Windows — C++ port of DietSentry4Android.
// Models, constants and shared declarations. Mirrors MainActivity.kt +
// DatabaseHelper.kt naming so the two codebases stay easy to diff.
#pragma once
...
std::wstring appDataDirectory();     // %APPDATA%\DietSentry4Windows (created)
